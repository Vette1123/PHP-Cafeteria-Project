            ...
            <div class="flex mt-28 flex-col p-4 rounded shadow-lg border self-start cart lg:sticky top-10">
                ...
                <form action="" method="POST" >
                    ...
                    <div class="form-controls mt-4">
                        ...
                        <textarea id="notes" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white " placeholder="Leave your notes here"></textarea>
                    </div>
                    ...
                    <div class="form-controls my-4">
                        ...
                        <select value="<?php if(isset($olddata->country)) {echo $olddata->country;} ?>" name="country" id="rooms" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                    ...
                    <hr>
                    <h2 class="text-4xl text-right">EGP <span class="total-price">55</span></h2>
                    <input type="sumbit" value="Confirm" name="cart"/>
                </form>
            </div>
            <!-- Drinks Sections Starts -->
            <div class="lg:col-span-2 col-start-1 drinks lg:col-start-2">
                <h2 class="text-4xl text-center lg:text-left font-bold my-6">Latest Order</h2>
                <section class="latest grid lg:grid-cols-3 grid-cols-1 gap-4 mt-4 mb-6">
                ...
                <hr>
                <h2 class="text-4xl text-center lg:text-left font-bold my-6">Drinks</h2>
                <section class="drinks grid lg:grid-cols-3 grid-cols-1 gap-4 mt-6 mb-6" >
                <!-- <div class="drink card w-100 bordered h-100 shadow-ms rounded hover:shadow-lg p-4 mb-4">
                        <img src="https://via.placeholder.com/300.png/09f/fff" class="w-full  card-image" />
                        <h3 class="mt-3 text-2xl  ">Tea</h3>
                    </div>
                    <div class="drink card w-100 bordered h-100 shadow-ms rounded hover:shadow-lg p-4 mb-4">
