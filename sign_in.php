    ...
    <div class="max-w-md w-full space-y-8">
      ...
      <form class="mt-8 space-y-6" action="validation.php" method="POST">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a href="forget.php" class="font-medium text-indigo-600 no-underline  hover: underline text-indigo-500 "> Forgot your password? </a>
          </div>
        </div>
        ...
        <div>
          <label class="font-normal font-sans italic ">
            ...
            if (isset($errors->page)) {
              echo "<p style='color:red'>$errors->page</p>";
            }
            ?>
          </label>
