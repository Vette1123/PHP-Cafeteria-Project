                ...
                <div class="text-center">
                    ...
                    ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <th scope="row" class="px-6 py-4 text-2xl text-gray-900 dark:text-white whitespace-nowrap text-center capitalize ">
                                <?php echo $user["name"] ?>
                            </th>
                            <td scope="row" class="px-6 py-4 text-2xl capitalize text-center capitalize ">
                                <?php echo $user["totalPrice"] ?>
                            </td>
                        </tr>
                        <!-- end for users -->
                        <div class="accordion">
                            <tr class="accordion-collapse collapse" id="<?php echo "ideksde" . $user['id'] ?>">
                                <td>
                                    <div class="">
                                        <table class="text-sm text-gray-500 dark:text-gray-400 my-12">
                                            <thead class=" text-2xl text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 ">
                                                <tr class=" text-center">
                                                    <th scope="col" class="px-6 py-3 hover:text-sky-400">
                                                        <div class="uppercase tracking-wide text-lg font-medium text-gray-500 dark:text-gray-100">Toggle Product</div>
                                                    </th>
                                                    <th scope="col" class="px-6 py-3 hover:text-sky-400">
                                                        <div class="uppercase tracking-wide text-lg font-medium text-gray-500 dark:text-gray-100">Quantity</div>
                                                    </th>
                                                    <th scope="col" class="px-6 py-3 hover:text-sky-400">
                                                        <div class="uppercase tracking-wide text-lg font-medium text-gray-500 dark:text-gray-100">Price</div>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <!-- start of orders -->
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <div class="accordion">
                                                        <tr class="accordion-collapse collapse" id="<?php echo "cont2" . $order['id'] ?>">
                                                            <td>
                                                                <div>
